...
<body>
    ...
    <section class="section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            <div class="col span span-1-of-4 box">
            ...
            <div class="col span span-1-of-4 box">
                <img src="resources/img/san-francisco.jpg" alt="San Francisco" class="city-img">
                <h3>San Francisco</h3>
                <div class="city-feature">
                    <ion-icon name="person"></ion-icon>
                    3700+ happy eaters
            ...
            <div class="col span-1-of-3">
                <div class="plan-box js--wp-4">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon name="checkmark-outline" size="small"></ion-icon>1 meal every day
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" size="small"></ion-icon>Order 24/7
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" size="small"></ion-icon>Access to newest creations
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" size="small"></ion-icon>Free delivery
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon name="checkmark-outline" size="small"></ion-icon>1 meal 10 days/month
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" size="small"></ion-icon>Order 24/7
                            </li>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon name="checkmark-outline" size="small"></ion-icon>1 meal
                            </li>
                            <li>
                                <ion-icon name="checkmark-outline" size="small"></ion-icon>Order from 8 am to 12 pm
                            </li>
                            <li>
        ...
        <div class="row">
            <form method="post" action="mailer.php" class="contact-form">
                ...
                <div class="row">
                    ...
                    <div class="col span-2-of-3">
                        <select name="find-us" id="find-us">
                            <option value="friends" selected>Friends/Family</option>
                ...
                <div class="row">
                    ...
                    <div class="col span-2-of-3">
                        <input type="submit" value="Send it!" class="submit-form">
                    </div>
                </div>
            </form>
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2">
                <ul class="social-links">
                    <li class="logo-facebook"><a href="#">
                            <ion-icon name="logo-facebook"></ion-icon>
                        </a></li>
                    <li class="logo-twitter"><a href="#">
                            <ion-icon name="logo-twitter"></ion-icon>
                        </a></li>
                    <li class="logo-instagram"><a href="#">
